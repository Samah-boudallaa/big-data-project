...
Le projet couvre la collecte, le stockage, le traitement et l’analyse des données, avec une comparaison entre **Hadoop MapReduce** et **Apache Spark**.
...
- Comparer les performances et la simplicité d’utilisation
